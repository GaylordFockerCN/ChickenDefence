...
protected:
    ...
    virtual void registerReactionEvent();

	virtual void OverLoad(Ref * pData);

	virtual void Superconduct(Ref * pData);

	virtual void Electro_Charged(Ref * pData);

	virtual void Shattered(Ref * pData);

	virtual void monsterReaction(Ref * pData);
