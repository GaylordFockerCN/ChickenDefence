...
void PageViewLayer::loadBg()
{
    ...
    auto pTitle = Label::createWithTTF("选择章节", "fonts/zh-cn.ttf", 30);
	//pTitle->enableOutline(Color4B::BLACK,1);
	pTitle->enableShadow();
    pTitle->setPosition(Vec2(480, 600));
    addChild(pTitle);
}
...
void PageViewLayer::createThemeFlags()
{
    ...
    auto tFlagCount = 3;//_pPageView->getPageCount();
